...
def tests(session):
    ...
    try:
        ...
        session.run(
            ...
            "--omit=src/saltext/msteams/*",
            "--include=tests/*",
        )
        try:
            session.run("coverage", "report", "--show-missing", "--include=src/saltext/msteams/*")
            ...
            #    "--include=src/saltext/msteams/*,tests/*"
            # )
        finally:
